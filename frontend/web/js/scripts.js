...
jQuery.fn.exists = function(){return this.length>0;}
 ...
 spytarget: document.getElementById('contentcontainer')
  ...
  /*  $('.main-category__items .col').each(function(e) {
    ...
    $('.header__nav-icons i.header__cart-icon').on("click", function() {
  ...
  how_much > top_height ? $('.header__nav').addClass('sticked-fix') : $('.header__nav').removeClass('sticked-fix');
  how_much > top_height_login ? $('nav .login').addClass('sticked-fix') : $('nav .login').removeClass('sticked-fix');
  how_much > icon_mob_menu ? $('nav .login').addClass('sticked-fix') : $('.mob-menu__icon').removeClass('sticked-fix');
  how_much > top_height_logo ? $('.header__big-logo').addClass('sticked-fix') : $('.header__big-logo').removeClass('sticked-fix');
});
